...
<div class="topbar">
  ...
  <label class="index-toggle"><input type="checkbox" id="tsRordered"> TS R-order</label>
...
function targetSuffix() {{ return tsRordered ? "_R_ordered" : "_native"; }}
